...
export const SectionHeader: React.FC<SectionHeaderProps> = ({
  ...
  return (
    <div className="w-full relative bg-gradient-to-l from-violet-300 to-violet-200 rounded-lg  flex flex-row justify-between">
      <div className="md:w-1/2 p-8 md:p-16 md:pt-12">{hero}</div>
      {action ? (
        <Link
          to={action.href}
          className="px-8 py-4 bg-indigo-700 text-neutral-50 text-base font-medium rounded-lg justify-center items-center gap-4 inline-flex"
        >
          <svg
            width="25"
            height="24"
